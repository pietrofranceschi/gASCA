...
In the ASCA Decomposition of Synthetic Count Data vignette we showed how
to run and visualize an ASCA decomposition relying on base graphics.
However, visualizations are often performed using `tidyverse` and
`ggplot`.

The aim of this article is to show how to visualize the results of an
ASCA decomposition using these packages. As in the previous case we will
use the synthetic data made available in the package:
...
The following plot shows the distribution of the counts for variables
`s1` and `s7` as a function of the design factors:
...
![](/home/franceschp/Projects/gASCA/vignettes/src/Asca_dec_count_data_tidy_files/figure-gfm/unnamed-chunk-2-1.png)<!-- -->

The effect of time on variable `s1` is clear. The presence of an
interaction between time and treatment is instead visible in the `s7`
profile.
...
The following plot shows the results of the decomposition and the
validation in terms of L2 norm of the terms, the variable importance and
the univariate pseudo-R2
...
![](/home/franceschp/Projects/gASCA/vignettes/src/Asca_dec_count_data_tidy_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
...
![](/home/franceschp/Projects/gASCA/vignettes/src/Asca_dec_count_data_tidy_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
...
![](/home/franceschp/Projects/gASCA/vignettes/src/Asca_dec_count_data_tidy_files/figure-gfm/unnamed-chunk-16-1.png)<!-- -->
